...
interface RawatInapSummaryReportPDFProps {
  data: {
  ...
  filters: {
    ...
    selectedPoliklinik?: string; // This represents bangsal for rawat inap
  };
}

export function RawatInapSummaryReportPDF({
  data,
  filters,
}: RawatInapSummaryReportPDFProps) {
  return (
    <Document>
      <Page size="A4" orientation="landscape" style={styles.page} wrap>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Pasien Rawat Inap, Pediode tanggal{" "}
